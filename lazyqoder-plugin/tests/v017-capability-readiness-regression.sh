...
assert records["code_navigation"]["receipt"] == {"owner": "lazyqoder-lsp-tooling", "schema_version": 1, "state": "ready"}
PY
...
printf 'v0.18 LazyQoder capability readiness regression: PASS\n'
