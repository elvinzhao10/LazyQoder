...
printf 'x' >> "$TMP/digest-buddy/lazyqoder-v1.2.3.tar.gz"
...
tampered="$first_path/LazyQoder/lazyqoder-v1.2.3.tar.gz"
chmod u+w "$tampered"
printf 'x' >> "$tampered"
chmod 0444 "$tampered"
expect_failure final-tamper "LazyQoder/lazyqoder-v1.2.3.tar.gz" \
