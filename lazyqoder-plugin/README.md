...
The package source in this worktree is the published stable v1.3.2 release. Package readiness does not prove native-host activation.
...
Bootstrap the published stable v1.3.2 route from a verified official source checkout, then use the
