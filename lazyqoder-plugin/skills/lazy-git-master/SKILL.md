...
version: 1.0.0
description: "Git workflow discipline for Qoder IDE: atomic commits, staging, commit-message style, rebase, squash, fixup, cherry-pick, branch management."
user-invocable: true
---
...
- **Git operations:** All git commands run via Qoder IDE Bash tool. No Codex-specific git wrappers.
