...
## v1.3.2 route and host readiness

This documentation boundary covers `qodercli-cli`, `qodercli-ide`, and
`qoder`; the package version is v1.3.2. v1.3.1 was tagged but its GitHub Release was not published. Marketplace is the default
