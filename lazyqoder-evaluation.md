...
The latest published stable release is v1.3.0; this candidate is not tagged or published.

The published stable v1.3.0 documentation covered `qodercli-cli`, `qodercli-ide`, and
`qoder`; this candidate documentation does not publish or alter a package. For Qoder CLI and
